Jedes Foodsoft-Konto (Account) verfügt über ein eigenes Profil mit den folgenden Informationen:
- Vor- und Nachname
- E-Mail Adresse
- Telefon
- Adresse
...
Bestellt wird innerhalb einer Bestellgruppe, in der sich mehrere Foodsoft-Konten befinden können (Familie, WG, etc.).
